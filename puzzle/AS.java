...
public class AS {
    ...
    // Realiza a busca A* utilizando a heurística selecionada
    public Solucao busca(Puzzle puzzle, int h) {

        // Inicia o contador de nodos gerados
        nodosGerados = 0;

        // Comparador para custo + estimativa
        CustoEstimativaComparator comparator = new CustoEstimativaComparator();
        ...
        while (!fila.isEmpty()) {
            ...
            // Retira o primeiro nodo da fila com menor custo + estimativa
            nodoAtual = fila.poll();
            ...
            for (int i = 0; i < filhos.size(); i++) {
                ...
                if (!(explorados.contains(filhoAtual.getID()) || (fronteira.containsKey(filhoAtual.getID())))) {
                    ...
                    if (fronteira.containsKey(filhoAtual.getID())) {
                        ...
                        // Substitui na lista o com menor custo + estimativa
